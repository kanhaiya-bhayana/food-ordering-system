...
import com.food.ordering.system.order.service.domain.valueobject.TackingId;
...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void initializeOrder(){
        ...
        tackingId = new TackingId(UUID.randomUUID());
    ...
    public static final class Builder {
        ...
        public Builder tackingId(TackingId val) {
            tackingId = val;
            return this;
        }
